...
public enum ReturnCode {
     ...
     * 用户余额不足 11017
     */
    USER_BALANCE_IS_INSUFFICIENT(11017, "用户余额不足"),
    /**
     * 手机格式校验失败 12000
     */
     ...
     * 数据动态注入失败 13004
     */
    DYNAMIC_INJECTION_FAILED(13004, "数据动态注入失败"),
    /**
     * json解析失败 13005
     */
    JSON_PARSING_FAILED(13005, "json解析失败"),
    /**
     * 用户上传文件异常 14000
     */
     ...
     * ai内容生成异常 16000
     */
    AI_CONTENT_GENERATION_EXCEPTION(16000, "ai内容生成异常"),
    /**
     * 数据库服务出错 20000
     */
     ...
     * 非法访问
     */
    ILLEGAL_ACCESS(40002, "非法访问"),
    /**
     * 实例化异常
     */
    INSTANTIATION_EXCEPTION(40003, "实例化异常");
